            ...
            <div className='AllQuestionDesign' >
                ...
                <p className='Question-one'>
                   ...
                   Context is primarily used when some data needs to be accessible by many   components at different nesting levels. Apply it sparingly because it makes component reuse more difficult. If you only want to avoid passing some props through many levels, component composition is often a simpler solution than context
                    ...
                    When you need to share data across multiple components that are not in a parent-child relationship.When you have a large application with many components that need access to the same data.When you need to avoid prop drilling and keep your code clean and readable.However,  important to note that overusing the Context API can make your code harder to understand and maintain. So, you should carefully consider whether Context API is the right solution for your particular use case. 
                ...
                The most common use case for useRef is to access the DOM nodes or elements in the component. When a ref is attached to a component, the ref object can be used to get a reference to the underlying DOM node or element. This allows you to manipulate the DOM directly, bypassing  virtual DOM, and access properties or methods of the underlying DOM node.
